...
#Region " Function "
    ...
    Function fctGetWidest(ByVal strText As String, ByVal intTxtHt As Integer, ByVal intWidest As Integer, ByVal fntFont As Font) As Integer
        ...
        With Me
            ...
            intWidth = .MeasureText(strText, fntFont, intTxtHt, sf, Me.Padding).Height
    ...
    Function fctGetHighest(ByVal strText As String, ByVal intTxtHt As Integer, ByVal intWidest As Integer, ByVal fntFont As Font, ByVal strFmt As StringFormat) As Integer
        ...
        With Me
            intHeight = .MeasureText(strText, fntFont, intWidest, strFmt, Me.Padding).Height
...
BackHere:
    ...
    Function GetLineSpace(ByVal intTextHeight As Integer) As Double
        Select Case G_ReportOptions.dblLineSpace
            ...
            Case Is > 1
                Return intTextHeight + Me.MeasureText("A", fntRegular, 1, sf, Me.Padding).Height * (G_ReportOptions.dblLineSpace - 1)
        End Select
    End Function
...
#Region " Print List "
    Function fctPrintMerchandisePriceList(ByVal dtMerchandiseList As DataTable, ByVal strSubHeading As String, _
                                          ByVal intLanguage As Integer, _
                                          ByVal blnIncludeNumber As Boolean, ByVal blnIncludeSupplier As Boolean, _
                                          ByVal blnIncludeCategory As Boolean, ByVal blnIncludePrice1 As Boolean, ByVal blnIncludePrice2 As Boolean, _
        ...
        Try
            ...
            If dtMerchandiseList.DefaultView.Count > 0 Then
                With Me
                    ...
                    intTextHeight = .MeasureText(strReportTitle, fntReportTitle, intAvailableWidth, sf, Me.Padding).Height
                    ...
                    'Sub Report Header
                    intTextHeight = .MeasureText(strSubHeading, fntRegular, intAvailableWidth, sf, Me.Padding).Height
                    ...
                    L_lngCol(1) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    NumberWidth = L_lngCol(1)

                    strX = cLang.GetString(clsEGSLanguage.CodeType.Products)
                    L_lngNameW = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace

                    strX = cLang.GetString(clsEGSLanguage.CodeType.Supplier)
                    L_lngCol(3) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    SupplierWidth = L_lngCol(3)

                    strX = cLang.GetString(clsEGSLanguage.CodeType.Category)
                    L_lngCol(4) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace

                    strX = cLang.GetString(clsEGSLanguage.CodeType.Price) & "-1"
                    L_lngCol(5) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    L_lngCol(6) = .MeasureText("/", fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    Price1Width = L_lngCol(5) + L_lngCol(6)

                    strX = cLang.GetString(clsEGSLanguage.CodeType.Price) & "-2"
                    L_lngCol(7) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    L_lngCol(8) = .MeasureText("/", fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    Price2Width = L_lngCol(7) + L_lngCol(8)
                    'L_lngCol(9) = .MeasureText("WWW", fntBold, intTextHeight, sf, me.padding).Height + intColumnSpace
                    ...
                    For Each drvReport In dtMerchandiseList.DefaultView
                        ...
                        If blnIncludeNumber Then
                            ...
                            If .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(1) Then
                                L_lngCol(1) = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                            End If
                        Else
                            L_lngCol(1) = 0
                        End If
                        ...
                        strX = drvReport("Name")
                        strX = Replace(strX, Chr(1), "")
                        If .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngNameW Then
                            L_lngNameW = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                        End If

                        If blnIncludeSupplier Then
                            strX = drvReport("suppliername")
                            strX = Replace(strX, Chr(1), "")
                            If .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(3) Then
                                L_lngCol(3) = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                            End If
                        Else
                            L_lngCol(3) = 0
                        End If
                        ...
                        If blnIncludeCategory Then
                            ...
                            strX = Replace(strX, Chr(1), "")
                            If .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(4) Then
                                L_lngCol(4) = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                                'L_lngCol(4) = 95
                            End If
                        Else
                            L_lngCol(4) = 0
                        ...
                        If blnIncludePrice1 Then
                            If Not IsDBNull(drvReport("price1")) Then
                                ...
                                If .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(5) Then
                                    L_lngCol(5) = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                                End If
                            End If
                            ...
                            If Not IsDBNull(drvReport("unitname1")) Then
                                ...
                                If .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(6) Then
                                    L_lngCol(6) = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                                End If
                            End If
                        ...
                        If blnIncludePrice2 Then
                            If Not IsDBNull(drvReport("price2")) Then
                                ...
                                If .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(7) Then
                                    L_lngCol(7) = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                                End If
                            End If
                            ...
                            If Not IsDBNull(drvReport("unitname2")) Then
                                ...
                                If .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(8) Then
                                    L_lngCol(8) = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                                End If
                            End If
...
GOHere:
                    ...
                    sf = New StringFormat(StringFormatFlags.NoClip)
                    strX = cLang.GetString(clsEGSLanguage.CodeType.Number)
                    intTextHeight = .MeasureText(strX, fntRegular, L_lngCol(1), sf, Me.Padding).Height
                    ...
                    'Column Headers
                    '--------------------------------------------------------------------------------------
                    'Number     Product     Wastage     Price       Tax     Date
                    '--------------------------------------------------------------------------------------
                    intCurrentY += 10
                    If blnIncludeNumber Then
                        strX = cLang.GetString(clsEGSLanguage.CodeType.Number)
                    ...
                    intCurrentY = 0
                    intMaxHeight = .MeasureText("A", fntRegular, intAvailableWidth, sf, Me.Padding).Height
                    ...
                    For Each drvReport In dtMerchandiseList.DefaultView
                        ...
                        If blnIncludePrice1 Then
                            ...
                            'strX = ""
                            'If Not IsDBNull(drvReport("price1")) Then strX = Format(drvReport("price1"), strPriceFromat)
                            'Dim widthPrice = .MeasureText(strX, fntRegular, intMaxHeight, sf, Me.Padding).Height
                            ...
                            'Dim widthUnit = .MeasureText(strX, fntRegular, intMaxHeight, sf, Me.Padding).Height
                        ...
                        If blnIncludePrice2 Then
                            ...
                            'strX = ""
                            'If Not IsDBNull(drvReport("price2")) Then strX = Format(drvReport("price2"), strPriceFromat)
                            'Dim widthPrice2 = .MeasureText(strX, fntRegular, intMaxHeight, sf, Me.Padding).Height
                            ...
                            'Dim widthUnit2 = .MeasureText(strX, fntRegular, intMaxHeight, sf, Me.Padding).Height
...
GoHere2:
    ...
    '01 December 2005
    Function fctPrintMerchandiseList(ByVal dtMerchandiseList As DataTable, ByVal strSubHeading As String, _
              ByVal intLanguage As Integer, _
              ByVal blnIncludeNumber As Boolean, ByVal blnIncludeWastage As Boolean, _
              ByVal blnIncludeTax As Boolean, ByVal blnIncludeDate As Boolean, ByVal blnIncludePrice As Boolean, _
              ByVal strFontName As String, ByVal sgFontSize As Single, _
              ByVal dblPageWidth As Double, ByVal dblPageHeight As Double, ByVal dblLeftMargin As Double, ByVal dblRightMargin As Double, _
              ByVal dblTopMargin As Double, ByVal dblBottomMargin As Double, Optional ByVal blLandscape As Boolean = False, _
              Optional ByVal strFontTitleName As String = "Arial", Optional ByVal sgFontTitleSize As Single = 16) As XtraReport 'VRP 05.11.2007
        ...
        If dtMerchandiseList.DefaultView.Count > 0 Then
            With Me
                ...
                L_lngCol(2) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace

                strX = cLang.GetString(clsEGSLanguage.CodeType.Price)
                L_lngCol(3) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace

                L_lngCol(4) = .MeasureText("/", fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace

                strX = cLang.GetString(clsEGSLanguage.CodeType.Tax)
                L_lngCol(5) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace

                strX = cLang.GetString(clsEGSLanguage.CodeType.Date_)
                L_lngCol(6) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace

                L_lngCol(7) = .MeasureText("WWW", fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                For Each drvReport In dtMerchandiseList.DefaultView
                    ...
                    If blnIncludeWastage Then
                        ...
                        If strX = "%" Then strX = ""
                        If .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(2) Then
                            L_lngCol(2) = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                        End If
                    Else
                        L_lngCol(2) = 0
                    End If
...
GoHere2:
    ...
    '30 November 2005
    Function fctPrintShoppingList(ByVal dtShoppingList As DataTable, ByVal strSubHeading As String, _
                                   ByVal blnWithGroup As Boolean, ByVal strGroupBy As String, _
                                   ByVal blnIncludePrice As Boolean, ByVal blnIncludeGrossQty As Boolean, ByVal blnIncludeNetQty As Boolean, _
                                   ByVal blnIncludeNumber As Boolean, _
                                   ByVal strFontName As String, ByVal sgFontSize As Single, _
                                   ByVal dblPageWidth As Double, ByVal dblPageHeight As Double, ByVal dblLeftMargin As Double, ByVal dblRightMargin As Double, _
                                   ByVal dblTopMargin As Double, ByVal dblBottomMargin As Double, Optional ByVal blLandscape As Boolean = False, _
                                   Optional ByVal strFontTitleName As String = "Arial", Optional ByVal sgFontTitleSize As Single = 16, _
                                   Optional ByVal OneOrMetricImperial As Boolean = False, Optional ByVal OneOrMetricImperialQuantityBasis As Integer = 1, _
            ...
            If dtShoppingList.DefaultView.Count > 0 Then
                With Me
                    ...
                    If blnWithGroup Then
                        intTextHeight = .MeasureText(strGroupBy, fntRegular, intAvailableWidth, sf, Me.Padding).Height
                    ...
                    'Get Column Width of wach header
                    sf = New StringFormat(StringFormatFlags.DirectionVertical)
                    L_lngCol(1) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Price), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace    'Price  --- ftb(1290)
                    L_lngCol(2) = .MeasureText("/", fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace        'Unit

                    L_lngCol(3) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.ImperialQuantityGross), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace  'Gross Qty --- ftb(132736)
                    L_lngCol(4) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.ImperialQuantityNet), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace  'Net Qty --- ftb(132614)
                    L_lngCol(5) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Unit), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace    'Unit  --- ftb(5100)

                    If OneOrMetricImperial Then
                        L_lngCol(6) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.MetricQuantityGross), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace  'Gross Qty --- ftb(132736)
                        L_lngCol(7) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.MetricQuantityNet), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace  'Net Qty --- ftb(132614)
                    Else
                        L_lngCol(6) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Gross_Qty), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace  'Gross Qty --- ftb(132736)
                        L_lngCol(7) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Net_Qty), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace  'Net Qty --- ftb(132614)
                    End If

                    L_lngCol(8) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Unit), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace    'Unit  --- ftb(5100)
                    L_lngCol(9) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Amount), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace   'Amount  --- ftb(5720)
                    L_lngCol(10) = .MeasureText("WWW", fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    L_lngCol(11) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Number), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace       'Number --- ftb(5500)
                    ...
                    For Each drvReport In dtShoppingList.DefaultView
                        ...
                        If blnIncludeGrossQty And blnIncludeNetQty Then
                            ...
                            If OneOrMetricImperial = False Then
                                ...
                                If .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(6) Then
                                    L_lngCol(6) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                                End If

                                strX = fctFormatNumericQuantity(dblQty, strUnitFormat, G_Options.RemoveTrailingZero, G_Options.QtyType)

                                If .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(7) Then
                                    L_lngCol(7) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                                End If

                                strX = strUnitName

                                If .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(8) Then
                                    L_lngCol(8) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                                End If
                            Else
                    ...
                    sf = New StringFormat(StringFormatFlags.NoClip)
                    intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Number), fntRegular, L_lngCol(11), sf, Me.Padding).Height '"Number"
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Products), fntRegular, L_lngNameW, sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Products), fntRegular, L_lngNameW, sf, Me.Padding).Height
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Price), fntRegular, L_lngCol(1), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Price), fntRegular, L_lngCol(1), sf, Me.Padding).Height '"Price"

                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.ImperialQuantityGross), fntRegular, L_lngCol(3), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.ImperialQuantityGross), fntRegular, L_lngCol(3), sf, Me.Padding).Height '"Imperial Gross Qty"
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.ImperialQuantityNet), fntRegular, L_lngCol(4), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.ImperialQuantityNet), fntRegular, L_lngCol(4), sf, Me.Padding).Height '"Imperial Net Qty"
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Unit), fntRegular, L_lngCol(5), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Unit), fntRegular, L_lngCol(5), sf, Me.Padding).Height '"Unit"

                    If OneOrMetricImperial Then
                        If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.MetricQuantityGross), fntRegular, L_lngCol(6), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.MetricQuantityGross), fntRegular, L_lngCol(3), sf, Me.Padding).Height '"Gross Qty"
                        If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.MetricQuantityNet), fntRegular, L_lngCol(7), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.MetricQuantityNet), fntRegular, L_lngCol(4), sf, Me.Padding).Height '"Net Qty"
                    Else
                        If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Gross_Qty), fntRegular, L_lngCol(6), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Gross_Qty), fntRegular, L_lngCol(3), sf, Me.Padding).Height '"Gross Qty"
                        If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Net_Qty), fntRegular, L_lngCol(7), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Net_Qty), fntRegular, L_lngCol(4), sf, Me.Padding).Height '"Net Qty"
                    End If


                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Unit), fntRegular, L_lngCol(8), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Unit), fntRegular, L_lngCol(5), sf, Me.Padding).Height '"Unit"
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Amount), fntRegular, L_lngCol(9), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Amount), fntRegular, L_lngCol(6), sf, Me.Padding).Height '"Amount"
...
Repeat:
                        ...
                        For intRow As Integer = 0 To foundRows.GetUpperBound(0)
                            ...
                            intTextHeightTemp = CInt(.MeasureText(strName, fntRegular, L_lngNameW - intColumnSpace, sf, Me.Padding).Height)
                            intTextHeight = intTextHeightTemp
                            If G_ReportOptions.blShrinkToFit Then
                                Do While Not intMaxHeight >= CInt(.MeasureText(strName, fntRegular, L_lngNameW - intColumnSpace, sf, Me.Padding).Height)
                                    sgFontSizeTemp -= 1
                                    fntRegular = New Font(strFontName, sgFontSizeTemp, FontStyle.Regular)
                                Loop
                                intTextHeight = intMaxHeight
                    ...
                    Else        'Without Grouping
                        ...
                        For Each drvReport In dtShoppingList.DefaultView
                            ...
                            If G_ReportOptions.blShrinkToFit Then
                                intTextHeightTemp = CInt(.MeasureText(strName, fntRegular, L_lngNameW - intColumnSpace, sf, Me.Padding).Height)
                                Do While Not intMaxHeight >= CInt(.MeasureText(strName, fntRegular, L_lngNameW, sf, Me.Padding).Height)
                                    sgFontSizeTemp -= 1
                                    fntRegular = New Font(strFontName, sgFontSizeTemp, FontStyle.Regular)
                                Loop
                                .Detail.Controls.AddRange(New XRControl() {fctMakeXRLabel(strName, fntRegular, intCurrentX, intCurrentY, L_lngNameW - intColumnSpace, intMaxHeight, DevExpress.XtraPrinting.TextAlignment.TopLeft)})
                    ...
                    intCurrentY += 10
                    MaxHeight = .MeasureText("A", fntRegular, intAvailableWidth, sf, Me.Padding).Height
                    ...
                    '    If .MeasureText(strCurrency, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace >= L_lngCol(7) Then
                    '        L_lngCol(7) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    '    End If
                    ...
                    '    strX = " "
                    '    L_lngCol(5) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Total), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
        ...
        End Try
    End Function
    Function fctPrintShoppingListWithoutImp(ByVal dtShoppingList As DataTable, ByVal strSubHeading As String, _
                                   ByVal blnWithGroup As Boolean, ByVal strGroupBy As String, _
                                   ByVal blnIncludePrice As Boolean, ByVal blnIncludeGrossQty As Boolean, ByVal blnIncludeNetQty As Boolean, _
                                   ByVal blnIncludeNumber As Boolean, _
                                   ByVal strFontName As String, ByVal sgFontSize As Single, _
                                   ...
                                   ByVal dblTopMargin As Double, ByVal dblBottomMargin As Double, Optional ByVal blLandscape As Boolean = False, _
                                   Optional ByVal strFontTitleName As String = "Arial", Optional ByVal sgFontTitleSize As Single = 16, _
                                   Optional ByVal blnIncludeMetricGrossQty As Boolean = False, Optional ByVal blnIncludeMetricNetQty As Boolean = False, _
                                   Optional ByVal blnIncludeImperialGrossQty As Boolean = False, Optional ByVal blnIncludeImperialNetQty As Boolean = False) As XtraReport 'VRP 15.11.2007
        ...
        Try
            If dtShoppingList.DefaultView.Count > 0 Then
                With Me
                    ...
                    L_lngCol(1) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Price), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace    'Price  --- ftb(1290)
                    L_lngCol(2) = .MeasureText("/", fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace        'Unit
                    L_lngCol(3) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Gross_Qty), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace  'Gross Qty --- ftb(132736)
                    L_lngCol(4) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Net_Qty), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace  'Net Qty --- ftb(132614)
                    L_lngCol(5) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Unit), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace    'Unit  --- ftb(5100)
                    L_lngCol(6) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Amount), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace   'Amount  --- ftb(5720)
                    L_lngCol(7) = .MeasureText("WWW", fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    L_lngCol(8) = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Number), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace       'Number --- ftb(5500)
                    ...
                    sf = New StringFormat(StringFormatFlags.NoClip)
                    intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Number), fntRegular, L_lngCol(8), sf, Me.Padding).Height '"Number"
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Products), fntRegular, L_lngNameW, sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Products), fntRegular, L_lngNameW, sf, Me.Padding).Height
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Price), fntRegular, L_lngCol(1), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Price), fntRegular, L_lngCol(1), sf, Me.Padding).Height '"Price"
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Gross_Qty), fntRegular, L_lngCol(3), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Gross_Qty), fntRegular, L_lngCol(3), sf, Me.Padding).Height '"Gross Qty"
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Net_Qty), fntRegular, L_lngCol(4), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Net_Qty), fntRegular, L_lngCol(4), sf, Me.Padding).Height '"Net Qty"
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Unit), fntRegular, L_lngCol(5), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Unit), fntRegular, L_lngCol(5), sf, Me.Padding).Height '"Unit"
                    If intTextHeight < .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Amount), fntRegular, L_lngCol(6), sf, Me.Padding).Height Then intTextHeight = .MeasureText(clang.GetString(clsEGSLanguage.CodeType.Amount), fntRegular, L_lngCol(6), sf, Me.Padding).Height '"Amount"
...
Repeat:
    ...
    Function fctPrintNutrientValuesList(ByVal dtNutrientList As DataTable, _
        ...
        If dtNutrientList.DefaultView.Count > 0 Then
            With Me
                ...
                sf = New StringFormat(StringFormatFlags.NoClip)
                intTextHeight = .MeasureText("A", fntBold, 100, sf, Me.Padding).Height

                intMaxColumnWidth = 52

                ReDim L_lngCol(17)
                sf = New StringFormat(StringFormatFlags.DirectionVertical)
                L_lngCol(1) = .MeasureText(G_Nutrient(1).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(2) = .MeasureText(G_Nutrient(1).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(3) = .MeasureText(G_Nutrient(2).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(4) = .MeasureText(G_Nutrient(3).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(5) = .MeasureText(G_Nutrient(4).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(6) = .MeasureText(G_Nutrient(5).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(7) = .MeasureText(G_Nutrient(6).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(8) = .MeasureText(G_Nutrient(7).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(9) = .MeasureText(G_Nutrient(8).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(10) = .MeasureText(G_Nutrient(9).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(11) = .MeasureText(G_Nutrient(10).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(12) = .MeasureText(G_Nutrient(11).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(13) = .MeasureText(G_Nutrient(12).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(14) = .MeasureText(G_Nutrient(13).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(15) = .MeasureText(G_Nutrient(14).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                ...
                L_lngCol(16) = .MeasureText(G_Nutrient(15).Name, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                    ...
                    For f As Integer = 1 To 34 '15
                        ...
                        If Not IsDBNull(drvReport(strNutField)) Then
                            If drvReport(strNutField).ToString <> "1.#INF" Then
                                ...
                                intTextWidth = .MeasureText(strNutrientValues(i), fntRegular, 0, sf, Padding).Width
                ...
                For Each drvReport In dtNutrientList.DefaultView
                    ...
                    For f As Integer = 1 To 34 '15
                        ...
                        If Not IsDBNull(drvReport(strNutField)) Then
                            ...
                            intTextWidth = .MeasureText(strX, fntRegular, intTextHeight, sf, Me.Padding).Height + intColumnSpace
                            If intTextWidth >= L_lngCol(i) Then L_lngCol(i) = intTextWidth
                        End If
                        i += 1
                ...
                For Each drvReport In dtNutrientList.DefaultView
                    ...
                    intTextHeightTemp = .MeasureText(strX, fntRegular, L_lngNameW - intColumnSpace, sf, Me.Padding).Height
                    intTextHeight = intTextHeightTemp
                    If G_ReportOptions.blShrinkToFit Then
                        Do While Not intMaxHeight >= CInt(.MeasureText(strX, fntRegular, L_lngNameW - intColumnSpace, sf, Me.Padding).Height)
                            sgFontSizeTemp -= 1
    ...
    Function PrintRecipeNutrientList(ByVal dtNutrientList As DataTable, ByVal intListeType As Integer, _
                                       ByVal intNutrientQty As Integer, ByVal strFontName As String, _
                                       ByVal sgFontSize As Single, ByVal dblPageWidth As Double, _
                                       ByVal dblPageHeight As Double, ByVal dblLeftMargin As Double, _
                                       ByVal dblRightMargin As Double, ByVal dblTopMargin As Double, _
                                       ByVal dblBottomMargin As Double, ByVal udtUser As structUser, _
                                       ByVal arrblNutrientDisplay() As Boolean, _
                                       Optional ByVal strFontTitleName As String = "Arial", Optional ByVal sgFontTitleSize As Single = 16) As XtraReport 'VRP 05.11.2007
        ...
        With Me
            ...
            End Select
            intTextWidth = .MeasureText(strX, fntHeader1, 0, sf, Padding).Width
            intTextHeight = .MeasureText(strX, fntHeader1, intTextWidth, sf, Me.Padding).Height
            ...
            intTextWidth = .MeasureText(strX, fntHeader2, 0, sf, Padding).Width
            intTextHeight = .MeasureText(strX, fntHeader2, intTextWidth, sf, Me.Padding).Height
        ...
        With Me
            ...
            L_NutrientCount = fctGetNutrientDetails(udtUser.CodeTrans, udtUser.Site.Code)
                ...
                For n As Integer = 1 To L_NutrientCount
                    If G_Nutrient(n).DisplayPosition = dn Then
                        If arrblNutrientDisplay(n) = True Then
                            ...
                            L_lngNutCol(n) = .MeasureText(strX, fntDetail1, 0, sf, Me.Padding).Width
                        End If
                        Exit For
                    End If
                Next
            ...
            For Each drv As DataRowView In dtNutrientList.DefaultView
                ...
                For n As Integer = 1 To L_NutrientCount
                    If arrblNutrientDisplay(n) = True Then
                        ...
                        '        strX = ""
                        '    End If
                        '    intTextWidth = .MeasureText(strX, fntDetail2, 0, sf, Me.Padding).Width
            ...
            For i As Integer = 1 To L_NutrientCount
                If arrblNutrientDisplay(i) = True Then '-- JBB 05.24.2012
                    ...
                    intTextHeight = .MeasureText(strX, fntDetail1, L_lngNutCol(i) - intColumnSpace, sf, Me.Padding).Height
            ...
            For Each drv As DataRowView In dtNutrientList.DefaultView
                    ...
                    If arrblNutrientDisplay(n) = True Then '-- JBB 05.24.2012
                        ...
                        If Not IsDBNull(drv(strX)) Then
                            ...
                            Else
                                strX = ""
                            End If
                            intTextHeight = .MeasureText(strX, fntDetail2, L_lngNutCol(n) - intColumnSpace, sf, Me.Padding).Height
                            If intTextHeight > L_lngNutRow Then L_lngNutRow = intTextHeight
                        End If
                ...
                If Not IsDBNull(drv("YieldName")) Then
                    strX = Trim(drv("YieldName"))
                    intTextHeight = .MeasureText(strX, fntDetail2, L_lngYieldCol - intColumnSpace, sf, Me.Padding).Height
                    If intTextHeight > L_lngNutRow Then L_lngNutRow = intTextHeight
                End If

                If Not IsDBNull(drv("Name")) Then
                    strX = VB.Trim(CType(drv("Name"), String))
                    intTextHeight = .MeasureText(strX, fntDetail2, L_lngNameCol - intColumnSpace, sf, Me.Padding).Height
                    If intTextHeight > L_lngNutRow Then L_lngNutRow = intTextHeight
                End If
    ...
    'VRP 25.06.2009
    Function PrintNutrientList(ByVal dtNutrientList As DataTable, ByVal intListeType As Integer, _
                                       ByVal intNutrientQty As Integer, ByVal strFontName As String, _
                                       ByVal sgFontSize As Single, ByVal dblPageWidth As Double, _
                                       ByVal dblPageHeight As Double, ByVal dblLeftMargin As Double, _
                                       ByVal dblRightMargin As Double, ByVal dblTopMargin As Double, _
                    ...
                    Select Case intDetail
                        ...
                        Case 2      ' Energy kj/kcal
                            ...
                            For iEnergy As Integer = 1 To 2 Step 1
                                Select Case iEnergy
                                    Case 1
                                        If Not IsDBNull(drvNutList(strFieldName)) And Not drvNutList(strFieldName).ToString = "1.#INF" Then
                                            strNutrientVal = fctStrNutrientValue(Format(CType(drvNutList("N" & CStr(intDetail - 1)), Double), G_Nutrient(intDetail - 1).Format), G_Nutrient(intDetail - 1).Format, intNutrientQty, dblNutrientFactor, cLang.GetString(clsEGSLanguage.CodeType.NA))
                                        End If
                                        xrCNutList = New XRTableCell
                                        xrCNutList.CanShrink = False
                                    ...
                                    Case 2
                                        If Not IsDBNull(drvNutList(strFieldName)) And Not drvNutList(strFieldName).ToString = "1.#INF" Then
                                            strNutrientVal = fctStrNutrientValue(Format(CType(drvNutList(strFieldName), Double), G_Nutrient(intDetail - 1).Format), G_Nutrient(intDetail - 1).Format, intNutrientQty, dblNutrientFactor, cLang.GetString(clsEGSLanguage.CodeType.NA))
                                        End If
                                        xrCNutList = New XRTableCell
                                        xrCNutList.CanShrink = False
                                        xrCNutList.Width = CInt(intHWidth)
                                        ' RDC 01.06.2014 : Replaced CDbl(strNutrientVal) to CDblDB(strNutrientVal)
                                        xrCNutList.Text = Format(CDblDB(strNutrientVal) / 4.184, G_Nutrient(intDetail - 1).Format)
                                        xrCNutList.Font = New Font(strFontName, sgFontSize, FontStyle.Regular)
                                        xrCNutList.TextAlignment = DevExpress.XtraPrinting.TextAlignment.TopCenter
                                        xrRNutList.Cells.Add(xrCNutList)
                                End Select
    ...
    '            intCurrentY = intTextHeight
    '            'Sub Report Header
    '            intTextHeight = .MeasureText(strRecipeSubHeading, fntRegular, intAvailableWidth, sf, Me.Padding).Height
    ...
    '            'Number
    '            strX = cLang.GetString(clsEGSLanguage.CodeType.Number)
    '            L_lngCol(1) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace + 2

    '            'Cost of Goods
    '            strX = cLang.GetString(clsEGSLanguage.CodeType.CostOfGoods)
    '            L_lngCol(2) = .MeasureText(fctGetLongerSubstring(strX), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace + 2

    '            Select Case G_Options.FactorType
    '                Case 0
    '                    strX = cLang.GetString(clsEGSLanguage.CodeType.Const)
    '                    L_lngCol(3) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace + 2
    '                Case 1
    ...
    '            strX = cLang.GetString(clsEGSLanguage.CodeType.Tax)
    '            L_lngCol(4) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace + 2

    '            strX = cLang.GetString(clsEGSLanguage.CodeType.Selling_Price)
    '            L_lngCol(5) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace + 2

    '            strX = cLang.GetString(clsEGSLanguage.CodeType.ImposedPrice)
    '            L_lngCol(6) = .MeasureText(fctGetLongerSubstring(strX), fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace + 2

    '            strX = cLang.GetString(clsEGSLanguage.CodeType.Date_)
    '            L_lngCol(7) = .MeasureText(strX, fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace + 2

    '            L_lngCol(8) = .MeasureText("WWW", fntBold, intTextHeight, sf, Me.Padding).Height + intColumnSpace + 2
    ...
    '                strX = cLang.GetString(clsEGSLanguage.CodeType.Number)
    '                intTextHeight = .MeasureText(strX, fntRegular, L_lngCol(1) - intColumnSpace, sf, Me.Padding).Height
    '            End If
    ...
    'VRP 27.07.2009
    Function PrintRecipeMenuListCoop(ByVal dtRecipeList As DataTable, ByVal strReportTitle As String, _
                                ByVal strRecipeSubHeading As String, ByVal intPageLanguage As Integer, _
                                ByVal blnIncludeNumber As Boolean, ByVal blnIncludeCostOfGoods As Boolean, _
                                ...
                                Optional ByVal sgFontTitleSize As Single = 16, _
                                Optional blnIncludeName As Boolean = False, _
                                Optional blnIncludeSubName As Boolean = False, _
                                Optional blnIncludeCategory As Boolean = False) As XtraReport
        ...
        With Me
            ...
            '>>Report Title<<
            strX = strReportTitle
            intTextHeight = .MeasureText(strX, fntTitle1, intAvailableWidth, sf, Me.Padding).Height
            ...
            intTextHeight = .MeasureText(strX, fntTitle2, intAvailableWidth, sf, Me.Padding).Height
            ...
            sf = New StringFormat(StringFormatFlags.DirectionVertical)
            strX = cLang.GetString(clsEGSLanguage.CodeType.Category)
            L_lngCol(1) = .MeasureText(strX, fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace

            strX = cLang.GetString(clsEGSLanguage.CodeType.Number)
            L_lngCol(2) = .MeasureText(strX, fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace

            strX = cLang.GetString(clsEGSLanguage.CodeType.CostOfGoods)
            L_lngCol(3) = .MeasureText(fctGetLongerSubstring(strX), fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace

            strX = cLang.GetString(clsEGSLanguage.CodeType.Date_)
            L_lngCol(4) = .MeasureText(strX, fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace + 25

            strX = cLang.GetString(clsEGSLanguage.CodeType.Const)
            L_lngCol(5) = .MeasureText(strX, fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace

            strX = cLang.GetString(clsEGSLanguage.CodeType.Tax)
            L_lngCol(6) = .MeasureText(strX, fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace

            strX = cLang.GetString(clsEGSLanguage.CodeType.Selling_Price)
            L_lngCol(7) = .MeasureText(strX, fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace

            strX = cLang.GetString(clsEGSLanguage.CodeType.ImposedPrice)
            L_lngCol(8) = .MeasureText(fctGetLongerSubstring(strX), fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace

            strX = "WWW"
            L_lngCol(9) = .MeasureText(strX, fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace
            ...
            If blnIncludeNumber Then
                strX = cLang.GetString(clsEGSLanguage.CodeType.Number)
                intTextHeight = .MeasureText(strX, fntTitle3, L_lngCol(2) - intColumnSpace, sf, Me.Padding).Height
            End If
        ...
        With Me
            ...
            For Each row As DataRowView In dtRecipeList.DefaultView
                ...
                If blnIncludeCategory Then
                    ...
                    intTextHeight = .MeasureText(strX, fntDetail2, L_lngCol(1) - intColumnSpace, sf, Me.Padding).Height
                    If G_ReportOptions.blShrinkToFit Then
                ...
                If blnIncludeSubName Then
                    ...
                    intTextHeight = .MeasureText(strX, fntDetail2, L_lngSubName - intColumnSpace, sf, Me.Padding).Height
                    If G_ReportOptions.blShrinkToFit Then
                        Do While Not intRowHeight >= intTextHeight
                            sgFontSizeTemp -= 1
                            fntDetail2 = New Font(strFontName, sgFontSizeTemp, FontStyle.Regular)
                ...
                If blnIncludeName Then
                    ...
                    intTextHeight = .MeasureText(strX, fntDetail2, L_lngName - intColumnSpace, sf, Me.Padding).Height
                    If G_ReportOptions.blShrinkToFit Then
                        Do While Not intRowHeight >= intTextHeight
                            sgFontSizeTemp -= 1
                            fntDetail2 = New Font(strFontName, sgFontSizeTemp, FontStyle.Regular)
                ...
                If blnIncludeNumber Then
                    ...
                    intTextHeight = .MeasureText(strX, fntDetail1, L_lngCol(2) - intColumnSpace, sf, Me.Padding).Height
                    If intRowHeight < intTextHeight Then intRowHeight = intTextHeight
                End If
                ...
                If blnIncludeCostOfGoods Then
                    ...
                    Else 'Total
                        ...
                        End If
                    End If
                    intTextHeight = .MeasureText(strX, fntDetail1, L_lngCol(3) - intColumnSpace, sf, Me.Padding).Height
                    If intRowHeight < intTextHeight Then intRowHeight = intTextHeight
                End If
                ...
                If blnIncludeDate Then
                    If Not IsDBNull(row("Dates")) Then
                        ...
                        intTextHeight = .MeasureText(strX, fntDetail1, L_lngCol(4) - intColumnSpace, sf, Me.Padding).Height
                        If intRowHeight < intTextHeight Then intRowHeight = intTextHeight
                    End If
                End If
                ...
                If blnIncludeFactor Then
                    ...
                    Else
                        strX = "---"
                    End If
                    intTextHeight = .MeasureText(strX, fntDetail1, L_lngCol(5) - intColumnSpace, sf, Me.Padding).Height
                    If intRowHeight < intTextHeight Then intRowHeight = intTextHeight
                End If
                ...
                If blnIncludeTax Then
                    ...
                    Else
                        strX = "---"
                    End If
                    intTextHeight = .MeasureText(strX, fntDetail1, L_lngCol(6) - intColumnSpace, sf, Me.Padding).Height
                    If intRowHeight < intTextHeight Then intRowHeight = intTextHeight
                End If
                ...
                If blnIncludeSellingPrice Then
                    ...
                    Else 'Total
                        ...
                        End If
                    End If
                    intTextHeight = .MeasureText(strX, fntDetail1, L_lngCol(7) - intColumnSpace, sf, Me.Padding).Height
                    If intRowHeight < intTextHeight Then intRowHeight = intTextHeight
                End If
                ...
                If blnIncludeImposedPrice Then
                    ...
                    Else 'Total
                        ...
                        End If
                    End If
                    intTextHeight = .MeasureText(strX, fntDetail1, L_lngCol(8) - intColumnSpace, sf, Me.Padding).Height
                    If intRowHeight < intTextHeight Then intRowHeight = intTextHeight
                End If
                ...
                If blnIncludeSubName Then
                    strX = Trim(CType(row("SubName"), String))
                    intTextHeight = .MeasureText(strX, fntDetail2, L_lngCol(2) - intColumnSpace, sf, Me.Padding).Height
    ...
    Function PrintRecipeMenuListWithGross(ByVal dtRecipeList As DataTable, ByVal strReportTitle As String, _
        ...
        With Me
            ...
            strX = cLang.GetString(clsEGSLanguage.CodeType.CostOfGoods)
            L_lngCol(2) = .MeasureText(fctGetLongerSubstring(strX), fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace
            ...
            L_lngCol(4) = .MeasureText(fctGetLongerSubstring(strX), fntTitle3, intTextHeight, sf, Me.Padding).Height + intColumnSpace
            ...
            For Each row As DataRowView In dtRecipeList.DefaultView
                ...
                intTextHeight = .MeasureText(strX, fntDetail1, intTextHeight, sf, Me.Padding).Height + intColumnSpace
            ...
            If blnIncludeNumber Then
                strX = cLang.GetString(clsEGSLanguage.CodeType.Number)
                intTextHeight = .MeasureText(strX, fntTitle3, L_lngCol(1) - intColumnSpace, sf, Me.Padding).Height
            End If
        ...
        With Me
            ...
            For Each row As DataRowView In dtRecipeList.DefaultView
                ...
                If blnIncludeNumber Then
                    strX = Replace(row("Number").ToString, Chr(1), "")
                    intTextHeight = .MeasureText(strX, fntDetail1, L_lngCol(1) - intColumnSpace, sf, Me.Padding).Height
                    If intRowHeight < intTextHeight Then intRowHeight = intTextHeight
                End If

                'Name
                strX = Trim(CType(row("Name"), String))
                intTextHeight = .MeasureText(strX, fntDetail2, L_lngNameW - intColumnSpace, sf, Me.Padding).Height
                If G_ReportOptions.blShrinkToFit Then
                    Do While Not intRowHeight >= intTextHeight
                        sgFontSizeTemp -= 1
                        fntDetail2 = New Font(strFontName, sgFontSizeTemp, FontStyle.Regular)
                ...
                If blnIncludeDate Then
                    If Not IsDBNull(row("Dates")) Then
                        'strX = fctConvertDate(CType(row("Dates"), Date))
                        strX = DirectCast(row("Dates"), DateTime).ToShortDateString 'JBQL format date automatically getting the culture info
                        intTextHeight = .MeasureText(strX, fntDetail1, L_lngCol(9) - intColumnSpace, sf, Me.Padding).Height
                        If intRowHeight < intTextHeight Then intRowHeight = intTextHeight
                    End If
                End If
    ...
    Function fctPrintMerchandiseThumbnailsList(ByVal dtMerchandiseList As DataTable, ByVal strSubHeading As String, _
        ...
        If dtMerchandiseList.DefaultView.Count > 0 Then
            With Me
                ...
                sf = New StringFormat(StringFormatFlags.NoClip)
                intTextHeight = (.MeasureText("A", fntRegular, intColumnWidth, sf, Me.Padding).Height) * 2
SetCountToZero:
...
#End Region
    ...
    Function fctMasterReport(ByVal dtToPrint As DataTable, _
                                        ...
                                        Optional ByVal printType As enumReportType = enumReportType.None, _
                                        Optional ByVal strFontTitleName As String = "Arial", Optional ByVal sgFontTitleSize As Single = 16, _
                                        Optional ByVal intCodePrintList As Integer = 0, Optional dtDetails2 As DataTable = Nothing, _
                                        Optional dtFootNote As DataTable = Nothing, Optional dtSteps As DataTable = Nothing, _
                                        Optional dtListeNotes As DataTable = Nothing) As XtraReport 'VRP 05.11.2007
    ...
    Private Sub SplitFooterAddress(ByVal strNote As String, ByVal intAW As Integer, ByVal intCX As Integer, ByRef intCY As Integer, ByVal align As TextAlignment)
        With Me
            Dim intLineSpace As Integer = .MeasureText("A", fntFooter, intAW, sf, Me.Padding).Height
            ...
            While i < arr.Length
                If arr(i).Trim.Length > 0 Then
                    strNote = arr(i)
                    sf = New StringFormat(StringFormatFlags.NoClip)
                    intTextHeight = .MeasureText("A", fntFooter, intAW, sf, Me.Padding).Height
                ...
                With G_ReportOptions
                    ...
                    Select Case G_ReportOptions.dblReportType
                        Case 1, 2, 3  'Recipe Standard,Modern
                            ...
                            DetailReport.fctPrintRecipeDetailEgs(foundRecipeDetails, foundKeywords, foundAllergens, strStyle, DisplaySubRecipeAstrisk, DisplaySubRecipeNormalFont, DisplayRecipeDetails, strMigrosParam, strCnn, .dtSteps, , foundNotes)
                        Case 4 'Layout
                        ...
                        Case 5  'Merchandise Details
                            ...
                            DetailReport.fctPrintMerchandiseEgsDetails(foundRecipeDetails, foundKeywords, foundAllergens, .dtProductLink, strCnn)
                        Case 6  'Recipe Costing
                            If DisplayRecipeDetails = 2 Then
                                DetailReport.fctPrintRecipeDetailsADF(foundRecipeDetails, .dtSteps, strCnn)
                            Else
                                ...
                                strFilter = "CodeListe =" & strCode
                                If Not IsNothing(.dtAllergens) Then foundAllergens = .dtAllergens.Select(strFilter) Else foundAllergens = Nothing
                                DetailReport.fctPrintRecipeCostingEGSStandard4(foundRecipeDetails, foundKeywords, foundAllergens, dtStep, dtListeNote, strCnn, udtUser.Code, strCode, .dtNotes, strFilter3, G_ReportOptions.intTranslation, G_ReportOptions.intPageLanguage)
                            End If
                        Case 7 'mcm 12.01.05 Menu Costing
...
#Region " MENU PLAN "
    ...
    Private Sub SplitPanelText(ByVal xrPanel As XRPanel, ByVal strX As String, ByVal intCX As Integer, ByRef intCY As Integer, ByVal align As TextAlignment)
        With Me
            Dim intLineSpace As Integer = .MeasureText("A", fntRegular, xrPanel.Width, sf, Me.Padding).Height
            intLineSpace = CInt(GetLineSpace(intLineSpace * 3 / 5))
            ...
            While i < arr.Length
                If arr(i).Trim.Length > 0 Then
                    strX = arr(i)
                    sf = New StringFormat(StringFormatFlags.NoClip)
                    intTextHeight = .MeasureText(strX, fntRegular, xrPanel.Width, sf, Me.Padding).Height
