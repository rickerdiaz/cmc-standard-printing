...
#End Region
    ...
    Public Function CreateReport(ByVal ds2 As DataSet, ByVal udtUser As structUser, ByVal strConnection As String, _
        ByRef documentOutput As Integer, Optional ByVal strPhotoPath As String = "", Optional ByVal strLogoPath As String = "", Optional ByVal strLogoPath2 As String = "", _
        ...
        Select Case printType
            Case enumReportType.MerchandisePriceList
                With G_ReportOptions
                    ...
                    Return Report.fctPrintMerchandisePriceList(dtDetails, strSubHeader, .intPageLanguage, _
                                    blnIncludeNumber, blnIncludeSupplier, blnIncludeCategory, blnIncludePrice, blnIncludePrice2, _
                                    strListFontName, sgListFontSize, dblPageWidth, dblPageHeight, dblListLeftMargin, dblListRightMargin, _
                                    dblListTopMargin, dblListBottomMargin, False, _
            ...
            Case enumReportType.MerchandiseList
                With G_ReportOptions
                    ...
                    .intPageLanguage = udtUser.CodeLang
                    .dblLineSpace = dblListLineSpace
                    Return Report.fctPrintMerchandiseList(dtDetails, strSubHeader, .intPageLanguage, _
                                    blnIncludeNumber, blnIncludeWastage, blnIncludeTax, blnIncludeDate, blnIncludePrice, _
                                    strListFontName, sgListFontSize, dblPageWidth, dblPageHeight, dblListLeftMargin, _
                                    dblListRightMargin, dblListTopMargin, dblListBottomMargin, False, _
                                    strFontTitleName, sgFontTitleSize) 'VRP 05.11.2007
            ...
            Case enumReportType.RecipeList
                ...
                With G_ReportOptions
                    ...
                    Return Report.PrintRecipeMenuListCoop(dtDetails, strReportTitle, strSubHeader, .intPageLanguage, _
                                   blnIncludeNumber, blnIncludeCostOfGoods, blnIncludeProfit, blnIncludeTax, blnIncludeSellingPrice, _
                                   blnIncludeImposedPrice, blnIncludeDate, strListFontName, sgListFontSize, dblPageWidth, dblPageHeight, _
                                   dblListLeftMargin, dblListRightMargin, dblListTopMargin, dblListBottomMargin, False, _
            ...
            Case enumReportType.MerchandiseNutrientList, enumReportType.RecipeNutrientList, enumReportType.MenuNutrientList
                ...
                If printType = enumReportType.RecipeNutrientList Then
                    ...
                    Return Report.PrintRecipeNutrientList(dtDetails, type, intNutrientQty, strListFontName, sgListFontSize, _
                                                   dblPageWidth, dblPageHeight, dblListLeftMargin, dblListRightMargin, _
                                                   dblListTopMargin, dblListBottomMargin, udtUser, arrblDisplay, strFontTitleName, sgFontTitleSize) 'Will add printStyle KMQDC'

                Else
                    Return Report.PrintNutrientList(dtDetails, type, intNutrientQty, strListFontName, sgListFontSize, _
                                                    dblPageWidth, dblPageHeight, dblListLeftMargin, dblListRightMargin, _
            ...
            Case enumReportType.ShoppingListDetail
                ...
                Return Report.fctPrintShoppingList(dtDetails, strSubHeader, blnEnableGroup, strGroupBy, blnIncludePrice, blnIncludeGrossQty, blnIncludeNetQty, _
                 blnIncludeNumber, strListFontName, sgListFontSize, dblPageWidth, dblPageHeight, dblListLeftMargin, dblListRightMargin, dblListTopMargin, dblListBottomMargin, False, _
                 strFontTitleName, sgFontTitleSize) 'VRP 05.11.2007
            ...
            Case enumReportType.MerchandiseDetail
                ...
                With G_ReportOptions
                    ...
                    Return Report.fctMasterReport(dtCodes, dblPageWidth, dblPageHeight, dblDetailLeftMargin, _
                                                  dblDetailRightMargin, dblDetailTopMargin, dblDetailBottomMargin, .strFontName2, .sgFontSize2, False, printType, _
                                                  .strFontTitleName, .sgFontTitleSize) 'VRP 05.11.2007
                End With
                ...
                Select Case printOption
                    Case enumPrintOptions.RecipeCosting, enumPrintOptions.RecipeCostingAndPreparation, enumPrintOptions.MenuCosting, enumPrintOptions.MenuCostingAndDescription
                        ...
                        With G_ReportOptions
                            'mcm 13.01.05
                            Select Case printOption
                                Case enumPrintOptions.RecipeCosting, _
                                    enumPrintOptions.RecipeCostingAndPreparation, _
                                    enumPrintOptions.MenuCosting, _
                            ...
                            If DisplayRecipeDetails = 2 Then 'ADF 'VRP 15.08.2008
                                ...
                                Return Report.fctMasterReport(dtNew, dblPageWidth, dblPageHeight, dblDetailLeftMargin, _
                                                           dblDetailRightMargin, dblDetailTopMargin, dblDetailBottomMargin, _
                                                           strDetailFontName2, sgDetailFontSize2, False, printType, _
                                                           .strFontTitleName, .sgFontTitleSize) 'VRP 05.11.2007
                            Else
                    ...
                    Case enumPrintOptions.RecipePreparation, enumPrintOptions.MenuDescription
                        ...
                        With G_ReportOptions
                            ...
                            Return Report.fctMasterReport(dtCodes, dblPageWidth, dblPageHeight, dblDetailLeftMargin, _
                                                          dblDetailRightMargin, dblDetailTopMargin, dblDetailBottomMargin, strDetailFontName2, sgDetailFontSize2, False, printType, _
                                                          .strFontTitleName, .sgFontTitleSize) 'VRP 05.11.2007
                        End With
    ...
    Public Function CreateReport_Test(ByVal ds2 As DataSet, ByVal strConnection As String, _
        ByRef documentOutput As Integer, Optional ByVal strPhotoPath As String = "", Optional ByVal strLogoPath As String = "", Optional ByVal strLogoPath2 As String = "", _
        Optional ByVal strSiteUrl As String = "", Optional ByVal IsCalcmenuOnline As Boolean = False, Optional blnIsAllowMetricImperial As Boolean = True, Optional intFoodlaw As Integer = 1, Optional CodePrintList As Integer = 0) As XtraReport
        ...
        Dim printOption As enumPrintOptions = cConfig.GetConfig(intCodePrintProfile, clsConfig.enumNumeros.PrPrintOptions, clsConfig.CodeGroup.printprofile, CStr(enumPrintOptions.RecipeCosting))
        Dim variation As enumPrintVariation = cConfig.GetConfig(intCodePrintProfile, clsConfig.enumNumeros.PrPrintVariation, clsConfig.CodeGroup.printprofile, CStr(enumPrintVariation.None))
        Dim printStyle As String = "01" 'cConfig.GetConfig(intCodePrintProfile, clsConfig.enumNumeros.PrStyle, clsConfig.CodeGroup.printprofile, CStr(enumPrintStyle.Standard))
        ...
        Select Case printType
            ...
            Case enumReportType.MerchandiseDetail
                ...
                With G_ReportOptions
                    ...
                    Return Report.fctMasterReport(dtCodes, dblPageWidth, dblPageHeight, dblDetailLeftMargin, _
                                                  dblDetailRightMargin, dblDetailTopMargin, dblDetailBottomMargin, .strFontName2, .sgFontSize2, False, printType, _
                                                  .strFontTitleName, .sgFontTitleSize, CodePrintList, dtDetails) 'VRP 05.11.2007
                End With
                ...
                Select Case printOption
                    ...
                    Case enumPrintOptions.RecipePreparation, enumPrintOptions.MenuDescription
                        ...
                        With G_ReportOptions
                            ...
                            Return Report.fctMasterReport(dtCodes, dblPageWidth, dblPageHeight, dblDetailLeftMargin, _
                                                          dblDetailRightMargin, dblDetailTopMargin, dblDetailBottomMargin, strDetailFontName2, sgDetailFontSize2, False, printType, _
                                                          .strFontTitleName, .sgFontTitleSize, intCodePrintList:=CodePrintList, dtDetails2:=dtDetails) 'VRP 05.11.2007
                        End With
                        'Return Report.fctPrintRecipeEgsStandard(dtDetail, dtKeyword, strSubStyle, blnIncludeNutrient, _
                        '            blnIncludeHACCP, blnPicturePathAccessible, blnIncludeNumber, blnIncludeCategory, blnIncludeSource, _
                        '             blnIncludeDate, blnIncludeCostOfGoods, blnIncluderemark, blnIncludeIngredientNumber, _
