...
Public Class clsGlobal
    ...
    Public Structure tReportOptions
        ...
        Public blnShrinkToFit As Boolean
...
err_fctConvertToFraction:
    ...
    ByVal dblSrQty As Double, ByVal lngSrLevel As Long, ByVal KiloCode As Long, ByVal LiterCode As Long) As Double
        ...
        Else
            ...
            If lngYieldUnit = LiterCode And Not blnFactorComputed Then
                'yield unit is Liter
                dblNutFactor = 10
                blnFactorComputed = True
            End If

            If lngMainUnitCode = LiterCode And dblSrQty <> 0 And Not blnFactorComputed Then
                'sub recipe unit is liter
                dblNutFactor = dblSrQty * 10 * dblUnitfactor
                blnFactorComputed = True
            End If
...
Err_Format:
        fctStrNutrientValue = strOriginal
