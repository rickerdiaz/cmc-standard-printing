...
Namespace CalcmenuAPI.Models
    ...
    Public Class RecipeData
        Private m_Info As New Models.Recipe
        Public Property Info As Models.Recipe
            Get
                Return m_Info
            End Get
            Set(value As Models.Recipe)
                m_Info = value
            End Set
        End Property
        Private m_Time As List(Of Models.RecipeTime)
        Public Property Time As List(Of Models.RecipeTime)
            Get
                Return m_Time
            End Get
            Set(value As List(Of Models.RecipeTime))
                m_Time = value
            End Set
        End Property
        Private m_Attachment As List(Of Models.RecipeAttachment)
        Public Property Attachment As List(Of Models.RecipeAttachment)
            Get
                Return m_Attachment
            End Get
            Set(value As List(Of Models.RecipeAttachment))
                m_Attachment = value
            End Set
        End Property
        Private m_Calculation As List(Of Models.RecipeCalculation)
        Public Property Calculation As List(Of Models.RecipeCalculation)
            Get
                Return m_Calculation
            End Get
            Set(value As List(Of Models.RecipeCalculation))
                m_Calculation = value
            End Set
        End Property
        Private m_Nutrition As List(Of Models.RecipeNutrition)
        Public Property Nutrition As List(Of Models.RecipeNutrition)
            Get
                Return m_Nutrition
            End Get
            Set(value As List(Of Models.RecipeNutrition))
                m_Nutrition = value
            End Set
        End Property
        Private m_Ingredient As List(Of Models.RecipeIngredient)
        Public Property Ingredient As List(Of Models.RecipeIngredient)
            Get
                Return m_Ingredient
            End Get
            Set(value As List(Of Models.RecipeIngredient))
                m_Ingredient = value
            End Set
        End Property
        Private m_Procedure As List(Of Models.RecipeProcedure)
        Public Property Procedure As List(Of Models.RecipeProcedure)
            Get
                Return m_Procedure
            End Get
        ...
        Public Property Keyword As List(Of Models.GenericTree)
            ...
            End Set
        End Property
        Private m_BrandSite As List(Of Models.RecipeBrandSite)
        Public Property BrandSite As List(Of Models.RecipeBrandSite)
            Get
                Return m_BrandSite
            End Get
            Set(value As List(Of Models.RecipeBrandSite))
                m_BrandSite = value
            End Set
        End Property
        ...
        Public Property Brands As List(Of Models.Brand)
            ...
            End Set
        End Property
        Private m_Publication As List(Of Models.RecipePublication)
        Public Property Publication As List(Of Models.RecipePublication)
            Get
                Return m_Publication
            End Get
            Set(value As List(Of Models.RecipePublication))
                m_Publication = value
            End Set
        End Property
        ...
        Public Property Project As List(Of Models.GenericTree)
            ...
            End Set
        End Property
        Private m_Translation As List(Of Models.RecipeTranslation)
        Public Property Translation As List(Of Models.RecipeTranslation)
            Get
            ...
            End Set
        End Property
        Private m_Comment As List(Of Models.RecipeComment)
        Public Property Comment As List(Of Models.RecipeComment)
            Get
                Return m_Comment
            End Get
            Set(value As List(Of Models.RecipeComment))
                m_Comment = value
            End Set
        End Property
        Private m_History As List(Of Models.RecipeHistory)
        Public Property History As List(Of Models.RecipeHistory)
            Get
                Return m_History
            End Get
            Set(value As List(Of Models.RecipeHistory))
                m_History = value
            End Set
        End Property
        ...
        Public Property Allergen As List(Of Models.ListeAllergen)
            ...
            End Set
        End Property
        Private m_RecipeLink As List(Of Models.RecipeLinkList)
        Public Property RecipeLink As List(Of Models.RecipeLinkList)
            Get
                Return m_RecipeLink
            End Get
            Set(value As List(Of Models.RecipeLinkList))
                m_RecipeLink = value
            End Set
        End Property

        Private m_Tabs As List(Of String)
        ...
        Public Property Label As Label
            ...
            End Set
        End Property
        Private m_IngredientAlternative As List(Of Models.IngredientAlternative)
        Public Property IngredientAlternative As List(Of Models.IngredientAlternative)
            Get
                Return m_IngredientAlternative
            End Get
            Set(value As List(Of Models.IngredientAlternative))
                m_IngredientAlternative = value
            End Set
        End Property
        Private m_LabelCompo As List(Of Models.LabelComposition)
        Public Property LabelComposition As List(Of Models.LabelComposition)
            Get
                Return m_LabelCompo
            End Get
            Set(value As List(Of Models.LabelComposition))
                m_LabelCompo = value
            End Set
        End Property

        Private m_NutrientSetCode As Integer
        Public Property NutrientSetCode As Integer
            Get
                Return m_NutrientSetCode
            End Get
            Set(value As Integer)
                m_NutrientSetCode = value
            End Set
        End Property

        Private m_NutrientSetValue As String
        Public Property NutrientSetValue As String
            Get
                Return m_NutrientSetValue
            End Get
            Set(value As String)
                m_NutrientSetValue = value
            End Set
        End Property
    End Class
    Public Class Recipe
        ...
        Public Property CodeSource As Integer
            ...
            End Set
        End Property
        Private m_CodeProductionLocation As Integer
        Public Property CodeProductionLocation As Integer
            Get
                Return m_CodeProductionLocation
            End Get
            Set(value As Integer)
                m_CodeProductionLocation = value
            End Set
        End Property
        Private m_ProductionLocationName As String
        Public Property ProductionLocationName As String
            Get
                Return m_ProductionLocationName
            End Get
            Set(value As String)
                m_ProductionLocationName = value
            End Set
        End Property
        ...
        Public Property CodeModifiedBy As Integer
            ...
            End Set
        End Property
        Private m_Picture As List(Of String)
        ...
        Public Property [Dates] As String
            ...
            End Set
        End Property
        Private m_CodeRecipeState As Integer
        Public Property CodeRecipeState As Integer
            Get
                Return m_CodeRecipeState
            End Get
            Set(value As Integer)
                m_CodeRecipeState = value
            End Set
        End Property
        Private m_RecipeState As String
        Public Property RecipeState As String
            Get
                Return m_RecipeState
            End Get
            Set(value As String)
                m_RecipeState = value
            End Set
        ...
        Public Property CCPDescription As String
            ...
            End Set
        End Property
        Private m_HACCP As String
        Public Property HACCP As String
            Get
                Return m_HACCP
            End Get
            Set(value As String)
        ...
        Public Property IsGlobal As Boolean
            ...
            End Set
        End Property
        Private m_WithDeclaration As Boolean
        Public Property WithDeclaration As Boolean
            Get
                Return m_WithDeclaration
            End Get
            Set(value As Boolean)
                m_WithDeclaration = value
            End Set
        End Property
        Private m_SmallPortion As String
        Public Property SmallPortion As String
            Get
                Return m_SmallPortion
            End Get
            Set(value As String)
                m_SmallPortion = value
            End Set
        End Property
        Private m_LargePortion As String
        Public Property LargePortion As String
            Get
                Return m_LargePortion
            End Get
            Set(value As String)
                m_LargePortion = value
            End Set
        End Property
        Private m_PriceSmallPortion As Double
        Public Property PriceSmallPortion As Double
            Get
                Return m_PriceSmallPortion
            End Get
            Set(value As Double)
                m_PriceSmallPortion = value
            End Set
        End Property
        Private m_PriceLargePortion As Double
        Public Property PriceLargePortion As Double
            Get
                Return m_PriceLargePortion
            End Get
            Set(value As Double)
                m_PriceLargePortion = value
            End Set
        End Property

        Private m_Testedby As String
        Public Property TestedBy As String
            ...
            End Set
        End Property
        Private m_DateTested As String
        Public Property DateTested As String
            Get
                Return m_DateTested
            End Get
            Set(value As String)
    ...
    Public Class RecipeTime
        Private m_RecipeTimeId As Integer
        Public Property RecipeTimeId As Integer
            Get
                Return m_RecipeTimeId
            End Get
            Set(value As Integer)
                m_RecipeTimeId = value
            End Set
        End Property
        Private m_RecipeTimeName As String
        Public Property RecipeTimeName As String
            Get
                Return m_RecipeTimeName
            End Get
            Set(value As String)
                m_RecipeTimeName = value
            End Set
        End Property
        Private m_RecipeTimeHH As Integer
        Public Property RecipeTimeHH As Integer
            Get
                Return m_RecipeTimeHH
            End Get
            Set(value As Integer)
                m_RecipeTimeHH = value
            End Set
        End Property
        Private m_RecipeTimeMM As Integer
        Public Property RecipeTimeMM As Integer
            Get
                Return m_RecipeTimeMM
            End Get
            Set(value As Integer)
                m_RecipeTimeMM = value
            End Set
        End Property
        Private m_RecipeTimeSS As Integer
        Public Property RecipeTimeSS As Integer
            Get
                Return m_RecipeTimeSS
            End Get
            Set(value As Integer)
                m_RecipeTimeSS = value
            End Set
        End Property
    ...
    Public Class RecipeCalculation
        ...
        Public Property Packaging As Double
            ...
            End Set
        End Property
        Private m_PackagingFactor As Double
        Public Property PackagingFactor As Double
            Get
                Return m_PackagingFactor
            End Get
            Set(value As Double)
                m_PackagingFactor = value
            End Set
        End Property
    ...
    Public Class RecipeNutrition
        ...
        Public Property TagName As String
            ...
            End Set
        End Property
        Private m_Value As Double ' RBAJ-2014.01.03 Changed from Double to String   'MKAM Changed back to Double
        ...
        Public Property Imposed As Double ' RBAJ-2014.01.03 Changed from Double to String
            Get
                Return m_Imposed
            End Get
            Set(value As Double)
    ...
    Public Class RecipeBrandSite
        ...
        Public Property DateTo As String
            ...
            End Set
        End Property
        Private m_HitCounter As Integer 'SM 5.7.2015 added for Recipe Hit Counter
    ...
    Public Class RecipeIngredient
        ...
        Private m_OrigPrice As Double
        Public Property OrigPrice() As Double
            Get
                Return m_OrigPrice
            End Get
        ...
        Private m_IsGenderSensitive As Boolean
        Public Property IsGenderSensitive As Boolean
            Get
                Return m_IsGenderSensitive
            End Get
            Set(value As Boolean)
                m_IsGenderSensitive = value
            End Set
        End Property
        ...
        Private m_PrefixCode As Integer
        ...
        Private m_PrefixGender As String
        Public Property PrefixGender As String
            Get
                Return m_PrefixGender
            End Get
            Set(value As String)
                m_PrefixGender = value
            End Set
        End Property

        Private m_IngredientStatus As Integer
        Public Property IngredientStatus As Integer
            Get
                Return m_IngredientStatus
            End Get
            Set(value As Integer)
                m_IngredientStatus = value
            End Set
        End Property

        Private m_Translation As List(Of Models.RecipeIngredientTranslation)
        Public Property Translation As List(Of Models.RecipeIngredientTranslation)
            Get
                Return m_Translation
            End Get
            Set(value As List(Of Models.RecipeIngredientTranslation))
                m_Translation = value
            End Set
        End Property

        Private m_Prices As List(Of Models.RecipeIngredientPriceList)
        Public Property Prices() As List(Of Models.RecipeIngredientPriceList)
            Get
                Return m_Prices
            End Get
            Set(ByVal value As List(Of Models.RecipeIngredientPriceList))
                m_Prices = value
            End Set
        End Property
        ...
        Public Property IngredientAlternative As List(Of Models.IngredientAlternative)
            ...
            End Set
        End Property
        'Private m_IngredientAlternativeTranslation As List(Of Models.IngredientAlternativeTranslation)
        'Public Property IngredientAlternativeTranslation As List(Of Models.IngredientAlternativeTranslation)
        '    Get
        '        Return m_IngredientAlternativeTranslation
        '    End Get
        '    Set(value As List(Of Models.IngredientAlternativeTranslation))
        '        m_IngredientAlternativeTranslation = value
        '    End Set
        'End Property
    End Class
    ...
    End Class
    Public Class RecipeIngredientPriceList
        Private m_CodeListe As Integer
        Public Property CodeListe() As Integer
            Get
                Return m_CodeListe
        ...
        Public Property Units() As List(Of Models.Unit)
            Get
                Return m_Units
            End Get
            Set(ByVal value As List(Of Models.Unit))
                m_Units = value
            End Set
        End Property
    End Class
    Public Class RecipeProcedure
        ...
        Public Property AbbrevNote As String
            ...
            End Set
        End Property
        Private m_Translation As List(Of Models.RecipeProcedureTranslation)
        Public Property Translation As List(Of Models.RecipeProcedureTranslation)
            Get
                Return m_Translation
            End Get
            Set(value As List(Of Models.RecipeProcedureTranslation))
                m_Translation = value
            End Set
        End Property
        ...
        End Property
    End Class
    Public Class RecipeProcedureTranslation
        Private m_NoteId As Integer
        Public Property NoteId As Integer
            Get
                Return m_NoteId
        ...
        End Property
    End Class
    Public Class RecipePublication
        Private m_Code As Integer
        Public Property Code As Integer
            Get
                Return m_Code
    ...
    Public Class RecipeTranslation
        ...
        Public Property HACCP As String
            ...
            End Set
        End Property
        Private m_DeclarationName
        Public Property DeclarationName As String
            Get
                Return m_DeclarationName
            End Get
            Set(value As String)
                m_DeclarationName = value
            End Set
        End Property
        Private m_SpecificDetermination
        Public Property SpecificDetermination As String
            Get
                Return m_SpecificDetermination
            End Get
            Set(value As String)
                m_SpecificDetermination = value
            End Set
        End Property
        Private m_Picture As String
        Public Property Picture As String
    ...
    Public Class RecipeCheckout
        ...
        End Property
    End Class
    Public Class RecipeUsedAsIngredient
        Private m_Code As Integer
        Public Property Code As Integer
            Get
                Return m_Code
        ...
        End Property
    End Class
    Public Class RecipeHistory '' TODO JTOC
    ...
    Public Class RecipeHistoryResponse
        ...
        Private m_Data As List(Of Models.RecipeHistory)
        Public Property Data As List(Of Models.RecipeHistory)
            Get
                Return m_Data
            End Get
            Set(value As List(Of Models.RecipeHistory))
        ...
        Public Sub New(data As List(Of Models.RecipeHistory), count As Integer)
            Me.Count = count
            Me.Data = data
        End Sub
    End Class
    Public Class Label
        ...
        Public DeclarationName As String
        Public SpecificDetermination As String
        ...
        Public PriceFor As Double
        Public Calculated As Double
        Public Note1 As Integer
        Public Note2 As Integer
        Public Note3 As Integer
        Public Certification As Integer
        Public CountryOfProduction As Integer
        Public PackagingMethod As Integer
        Public Storage As Integer
    End Class
    Public Class IngredientAlternative
        Public CodelisteMain As Integer
        Public Codeliste As Integer
        Public IngredientName As String
        Public CodelisteAlternative As Integer
        Public AlternativeName As String
    End Class
    'Public Class IngredientAlternativeCodeTrans
    '    Public CodeTrans As Integer
    '    Public IngredientAlternativeTranslation As List(Of IngredientAlternativeTranslation)
    'End Class
    Public Class IngredientAlternativeTranslation
        Public CodelisteMain As Integer
        Public Codeliste As Integer
        Public IngredientName As String
        Public CodelisteAlternative As Integer
    ...
    Public Class LabelComposition
        Public CodeListe As Integer
        Public CompoType As Integer
        Public CodeTrans As Integer
        Public ImposedComposition As String
        Public IsValidated As Boolean
    End Class

    Public Class LabelSalesSite
        Public Code As Integer
        ...
        Public IsProductionLocation As Boolean
        Public IsSalesSite As Boolean
