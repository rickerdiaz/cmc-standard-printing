...
namespace CalcmenuAPI
{
    ...
    public class TranslationController : ControllerBase
    {
        ...
        public ActionResult<List<Models.GenericList>> GetTranslationList(int codesite)
        {
            try
            {
                var ds = new DataSet();
        ...
        public ActionResult<List<Models.RecipeIngredientTranslation>> GetIngredientTranslation(int codeliste, int codesite = -1, int excludecodetrans = -1)
        {
            try
            {
                var list = new List<Models.RecipeIngredientTranslation>();
                using var cmd = new SqlCommand();
                using var cn = new SqlConnection(ConnectionString);
                cmd.Connection = cn;
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                while (dr.Read())
                {
                    list.Add(new Models.RecipeIngredientTranslation
                    {
        ...
        public ActionResult<List<Models.RecipeIngredientTranslation>> GetRecipeIngredientTranslation(int codeliste, int codesite = -1, int excludecodetrans = -1)
        {
            try
            {
                var list = new List<Models.RecipeIngredientTranslation>();
        ...
        public ActionResult<List<Models.RecipeProcedureTranslation>> GetRecipeProcedureTranslation(int codeliste, int excludecodetrans = -1)
        {
            try
            {
                var list = new List<Models.RecipeProcedureTranslation>();
                using var cmd = new SqlCommand();
                using var cn = new SqlConnection(ConnectionString);
                cmd.Connection = cn;
                cmd.CommandType = CommandType.StoredProcedure;
                ...
                while (dr.Read())
                {
                    list.Add(new Models.RecipeProcedureTranslation
                    {
